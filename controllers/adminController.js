...
const updateProduct = async (req, res) => {
    ...
    try {
        ...
        await Product.findByIdAndUpdate({ _id: id }, { $set: { productName: name, productDescription: description,productCategory:productCategory,price: price, stockCount: count, imageUrls: productImages } })
